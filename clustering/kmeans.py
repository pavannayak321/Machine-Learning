...
plt.scatter(X[y_means==1,0],X[y_means==1,1],c='blue',s=100)
plt.scatter(X[y_means==2,0],X[y_means==2,1],c='green',s=100)
plt.scatter(X[y_means==3,0],X[y_means==3,1],c='cyan',s=100)
plt.scatter(X[y_means==4,0],X[y_means==4,1],c='magenta',s=100)
